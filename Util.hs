...
negationNF :: (Expression -> Type) -> Expression -> Expression
negationNF typing boolExpr = case contents boolExpr of
  UnaryExpression Not e -> case contents e of
    UnaryExpression Not e' -> negationNF typing e'
    BinaryExpression And e1 e2 -> negationNF typing (enot e1) ||| negationNF typing (enot e2)
    BinaryExpression Or e1 e2 -> negationNF typing (enot e1) |&| negationNF typing (enot e2)
    BinaryExpression Implies e1 e2 -> negationNF typing e1 |&| negationNF typing (enot e2)
    BinaryExpression Equiv e1 e2 -> (negationNF typing e1 |&| negationNF typing (enot e2)) |&| (negationNF typing (enot e1) |&| negationNF typing e2)
    ...
    Quantified Forall tv vars e' -> attachPos (position e) (Quantified Exists tv vars (negationNF typing (enot e')))
    Quantified Exists tv vars e' -> attachPos (position e) (Quantified Forall tv vars (negationNF typing (enot e')))
    _ -> boolExpr
